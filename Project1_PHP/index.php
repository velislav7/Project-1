...
<section id="description-section" class="section">
        <div class="description">
           ...
           <img id="page-divider" src="<?php bloginfo('template_url'); '/http://onepage2.oxy.host/wp-content/uploads/sites/19/2017/11/Rectangle-15-Copy-6@2x.png'?>" class="sc-image">
           <div id="new-row">
              <div class="facts-blocks">
                 ...
                 <div id="sc-img-text1" class="text-imgs">Five star service, always.</div>
              </div>
               <div class="facts-blocks">
                  <svg class="icon-fact" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                  </svg>                
                  <div id="sc-img-text1" class="text-imgs">1,000s of happy customers.</div>
                  </div>
                  <div class="facts-blocks">
                     <svg class="icon-fact" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                     ...
                     <div id="sc-img-text1" class="text-imgs">We're your neighbors
                        (and have been for years).</div>
                  </div>
                  <div class="facts-blocks">
                     <svg class="icon-fact" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                     </svg>                   
                  <div id="sc-img-text1" class="text-imgs">Quick cash quarantee.</div>
                  </div>
